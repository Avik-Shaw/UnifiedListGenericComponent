/*
    Name: UnifiedListFeeder
    Description: This component is a wrapper component for the UnifiedList component.
    Author: Avik Shaw
    Date: 2026-01-11
    Version: 1.0
*/
...
export default class UnifiedListFeeder extends LightningElement {
    @api recordId;
    @api objectApiName;
    @api sourcedata = null;
